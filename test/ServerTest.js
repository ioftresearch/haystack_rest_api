...
/**
 * ServerTest -- this test requires an instance of the TestDatabase.
 * @constructor
 */
function ServerTest() {}
ServerTest.prototype = Object.create(Test.prototype);
...
function verifyAuth() {
  HClient.open(uri, user, pass, function(err, res) {
    if (err) throw err;
    client = res;
    runTests();
  });
...
ServerTest.test = function(callback) {
  cb = callback;
